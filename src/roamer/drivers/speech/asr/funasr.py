...
from roamer.drivers.speech.asr.base import ASRDriver
...
class FunASRDriver(ASRDriver):
    ...
    def transcribe(self, audio_path: str) -> dict[str, Any]:
        ...
        if not Path(audio_path).exists():
            return error("asr_failed", f"Audio file not found: {audio_path}")
        ...
        if not result:
            return error("asr_failed", "No transcription result")
