...
from roamer.plugins.interaction.drivers.bluetooth.base import BluetoothDriver
    ...
    def connect(self, address: str) -> dict[str, Any]:
        ...
        try:
            ...
            return error(
                ...
                error_code=ErrorCode.BLUETOOTH_CONNECT_TIMEOUT,
            )
        except FileNotFoundError:
            return error(
                "bluetooth_not_available",
                "bluetoothctl not installed",
                error_code=ErrorCode.DEPENDENCY_BLUETOOTH_BLUETOOTHCTL_MISSING,
            )
        ...
        return error(
            ...
            error_code=ErrorCode.BLUETOOTH_CONNECT_FAILED,
        )
    ...
    def disconnect(self, address: str) -> dict[str, Any]:
        ...
        try:
            ...
            return error(
                ...
                error_code=ErrorCode.BLUETOOTH_DISCONNECT_TIMEOUT,
            )
        except FileNotFoundError:
            return error(
                "bluetooth_not_available",
        ...
        return error(
            "bluetooth_error",
            f"Failed to disconnect: {output.strip()}",
            error_code=ErrorCode.BLUETOOTH_DISCONNECT_FAILED,
        )
