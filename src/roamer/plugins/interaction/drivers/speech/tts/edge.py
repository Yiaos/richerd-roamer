    ...
    def synthesize(self, text: str, output: str, style: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            return error(
                ...
                error_code=ErrorCode.DEPENDENCY_TTS_EDGE_TTS_MISSING,
            )
    ...
    def _convert_mp3_to_wav(self, mp3_path: str, wav_path: str) -> dict[str, Any]:
        ...
        try:
            ...
            return error(
                ...
                error_code=ErrorCode.AUDIO_CONVERT_TIMEOUT,
            )
        except FileNotFoundError:
            return error(
                "tts_failed",
                "ffmpeg not found",
                error_code=ErrorCode.DEPENDENCY_AUDIO_FFMPEG_MISSING,
            )
        ...
        if result.returncode != 0:
            return error(
                ...
                error_code=ErrorCode.AUDIO_CONVERT_FAILED,
            )
